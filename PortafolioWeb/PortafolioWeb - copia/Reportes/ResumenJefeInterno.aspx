...
GROUP BY VISTAHERMOSA.UNIDAD.NOMBRE_UNIDAD, derivedtbl_1.EXPR1, derivedtbl_2.EXPR1, derivedtbl_3.EXPR1"></asp:SqlDataSource>
        ...
        <br />
        <h1>Resumen cuantitativo de permisos administrativos</h1>

        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="933px" Height="385px" style="margin-bottom: 1px">
