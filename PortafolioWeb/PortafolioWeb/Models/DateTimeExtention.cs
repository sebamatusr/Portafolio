...
namespace PortafolioWeb.Models
{
    ...
    {
        public static DateTime AddWorkDays(this DateTime date, int workingDays, params Feriados[] bankHolidays)
        {
        ...
        public static int BusinessDaysUntil(this DateTime firstDay, DateTime lastDay, params Feriados[] bankHolidays)
        {
            ...
            foreach (Feriados bankHoliday in bankHolidays)
            {
                DateTime bh = DateTime.Parse(bankHoliday.date);
